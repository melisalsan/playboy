...
public class SwerveModule extends SubsystemBase {
  ...
  public SwerveModule(int moduleNumber, boolean driveMTRinverted, SwerveModuleConstants moduleConstants) {
    this.moduleNumber = moduleNumber;
    angleOffset = moduleConstants.angleOffset;

    /* Angle Encoder Config */
    angleEncoder = new CANcoder(moduleConstants.cancoderID, "Civ Civ");
    configAngleEncoder();
    ...
    driveMotor.setInverted(driveMTRinverted);
    configDriveMotor();
